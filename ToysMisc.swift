...
class ToysMisc: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate
{
    ...
    let markets = ["eBay", "Mercari", "Paypal", "Custom"]
    
    var currentMarket = "eBay"
...
extension ToysMisc : UITextFieldDelegate
{
