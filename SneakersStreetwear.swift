...
class SneakersStreetwear: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate
{
    ...
    let markets = ["StockX", "GOAT", "Grailed", "eBay", "Paypal Invoice", "Custom"]
    
    var currentMarket = "StockX"
   ...
   var audioPlayer = AVAudioPlayer()//sound
    ...
    @IBAction func calculateButtonPushed(_ sender: Any)
    {
        ...
        stockxPercent += 0.03;// for the paypal or direct deposit fee
        ...
        var aR = double_t(0.0)
            ...
            //stockX takes 9% + paypal 3% = 12%
        if (currentMarket == "StockX")
        {
            aR = double_t (sP! * (1 - stockxPercent))
        }
            //goat takes 9.5% + cashout 2.9% + $5
        else if (currentMarket == "GOAT")
        {
            print(sP!)
            sP = sP! * 0.905 - 5
            aR = double_t (sP! * 0.971)
        }
            //grailed takes 6% + cashout 2.9% + $0.30
        else if (currentMarket == "Grailed")
        {
            aR = double_t (sP! * 0.911 - 0.30)
        }
            
        else if (currentMarket == "eBay")
        {
            aR = double_t (sP! * 0.871 - 0.30)
        }
            //paypal takes 2.9% + 0.30
        else if (currentMarket == "Paypal Invoice")
        {
    ...
    //Determines Stock X Percentage based on lvl entered
    func stockXlevelCheck()
    {
        if (stockxlvlAmount == 1)
        {
            stockxPercent = 0.095
        }
        else if (stockxlvlAmount == 2)
        {
            stockxPercent = 0.09
        }
        else if (stockxlvlAmount == 3)
        {
            stockxPercent = 0.085
        }
        else if (stockxlvlAmount == 4)
        {
            stockxPercent = 0.08
        }
    }
...
extension SneakersStreetwear : UITextFieldDelegate
{
